...
//var_dump (e_PLUGIN.'glossary/glossary_trait.php');
...
// Defined as shortcode, so can be templated.....
	function sc_browse_letter($approved = 1)
	{
...
$template   = e107::getTemplate('glossary', 'glossary'.((deftrue('BOOTSTRAP') === 3)?"bootstrap3":"table") );
...
*/
			$text .= e107::getParser()->parseTemplate($template[($ok?'WORD_CHAR_LINK':'WORD_CHAR_NOLINK')], FALSE, $this);
...
*/
				$text .= e107::getParser()->parseTemplate($template[($arrletters[$wcar]?'WORD_CHAR_LINK':'WORD_CHAR_NOLINK')], FALSE, $this);
		}
		$text = e107::getParser()->parseTemplate($template['WORD_ALLCHAR_PRE'], FALSE).$text.e107::getParser()->parseTemplate($template['WORD_ALLCHAR_POST'], FALSE);
		}
    else
    {
...
//    $pref = e107::getPlugConfig('glossary')->getPref();
		$text = "";
		$mains = "";
		$baseurl = e_PLUGIN."glossary/glossary.php";
